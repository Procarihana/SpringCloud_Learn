package com.luwei.gateway.filter;
...
import com.luwei.gateway.service.ValidateCodeService;
...
public class ValidateCodeFilter extends AbstractGatewayFilterFactory<Object> {
    ...
    // APP端密码登录
    private final static String APP_AUTH_URL = "/auth/app/login";
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ...
            || !StringUtils.containsIgnoreCase(request.getURI().getPath(), APP_AUTH_URL)) {
