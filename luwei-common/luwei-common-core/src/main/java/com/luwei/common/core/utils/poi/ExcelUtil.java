package com.luwei.common.core.utils.poi;
...
import com.luwei.common.core.annotation.Excel.Type;
import com.luwei.common.core.annotation.Excels;
...
import com.luwei.common.core.utils.file.FileTypeUtils;
import com.luwei.common.core.utils.file.ImageUtils;
import com.luwei.common.core.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public void exportExcel(HttpServletResponse response, List<T> list, String sheetName, String fileName) throws IOException {
        ...
        response.setHeader("Content-Disposition", String.format("attachment; filename=%s", URLEncoder.encode(fileName, "UTF-8") + ".xls"));
        this.init(list, sheetName, Type.EXPORT);
        exportExcel(response.getOutputStream());
    }
