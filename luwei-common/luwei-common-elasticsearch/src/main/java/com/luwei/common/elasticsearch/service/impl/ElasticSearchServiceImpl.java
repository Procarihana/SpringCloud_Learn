package com.luwei.common.elasticsearch.service.impl;

import cn.hutool.core.bean.BeanUtil;
import com.luwei.common.elasticsearch.service.IElasticSearchService;
...
public class ElasticSearchServiceImpl implements IElasticSearchService {
    ...
    @Override
    public void putMappingRequest(String index, String sourceStr) {
        try {
            PutMappingRequest request = new PutMappingRequest(index);
            request.source(sourceStr, XContentType.JSON);
            client.indices().putMapping(request, RequestOptions.DEFAULT);
        } catch (IOException e) {
            log.error("设置mapping【{}】失败", index, e);
        }
    }
